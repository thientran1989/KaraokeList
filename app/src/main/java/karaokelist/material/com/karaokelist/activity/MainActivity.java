...
import karaokelist.material.com.karaokelist.fragment.BaiHat_Fragment;
import karaokelist.material.com.karaokelist.fragment.MainFragment;
import karaokelist.material.com.karaokelist.fragment.ViewPagerFragment;
...
public class MainActivity extends NavigationLiveo implements OnItemClickListener {
    ...
    public void onInt(Bundle savedInstanceState) {
        ...
        mHelpLiveo.add(getString(R.string.ariang_namso), R.mipmap.ic_inbox_black_24dp, 7);
        mHelpLiveo.addSubHeader(getString(R.string.tuychonkhac)); //Item subHeader
        mHelpLiveo.add(getString(R.string.ariang_namso_eng), R.mipmap.ic_star_black_24dp);
        mHelpLiveo.add(getString(R.string.ariang_sauso), R.mipmap.ic_send_black_24dp);
        mHelpLiveo.add(getString(R.string.ariang_sauso_eng), R.mipmap.ic_drafts_black_24dp);
